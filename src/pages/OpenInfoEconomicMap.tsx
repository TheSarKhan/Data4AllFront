      ...
      <div className="w-full lg:ml-32">
        <div className="mb-28">
          <h1 className="md:text-4xl text-white font-semibold">
            Xəritə üzrə iqtisadi göstəricilər
          </h1>
          <div className="flex flex-wrap gap-4 mt-11">
            <button className="p-5 bg-[rgba(255,255,255,0.15)] rounded-[8px] text-white font-medium text-lg">
              Restoran və kofeşoplar
            </button>
            <button className="p-5 bg-[rgba(255,255,255,0.15)] rounded-[8px] text-white font-medium text-lg">
              İstirahət yerləri
            </button>
            ...
            <button className="p-5 bg-[rgba(255,255,255,0.15)] rounded-[8px] text-white font-medium text-lg">
              Otellərin və əşyalı mənzillərin siyahısı
            </button>
            <button className="p-5 bg-[rgba(255,255,255,0.15)] rounded-[8px] text-white font-medium text-lg">
              Hava limanlarının siyahısı
            </button>
            <button className="p-5 bg-[rgba(255,255,255,0.15)] rounded-[8px] text-white font-medium text-lg">
              Digərlər
            </button>
